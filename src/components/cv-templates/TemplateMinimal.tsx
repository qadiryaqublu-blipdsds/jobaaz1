    ...
    <div id="cv-preview-minimal" className="bg-white text-slate-800 p-8 rounded-lg shadow-sm border border-slate-100 font-sans max-w-[850px] mx-auto min-h-[1050px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        {languages && languages.length > 0 && (
          <div>
            <h2 className="text-xs font-semibold uppercase tracking-widest text-slate-400 mb-2">{terms.languages}</h2>
      ...
      {projects && projects.length > 0 && (
        <div>
          <h2 className="text-xs font-semibold uppercase tracking-widest text-slate-400 mb-2">{terms.projects}</h2>
