...
export const TemplateEntryStudent: React.FC<TemplateProps> = ({ data, showPhoto = true }) => {
  ...
  return (
    <div id="cv-preview-entry-student" className="bg-white text-slate-800 p-8 font-sans max-w-[850px] mx-auto min-h-[1050px] border border-sky-100">
      {/* Top Banner Header */}
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
          {displayPhoto && (
            <img
              ...
              className={`${getPhotoClasses(personalInfo.photoSize, personalInfo.photoShape)} border-2 border-sky-400 shadow-sm`}
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <p className="text-sm sm:text-base font-semibold text-sky-700 mt-0.5">
              {personalInfo.jobTitle || ''}
            </p>
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-x-4 gap-y-1 text-xs text-slate-600 mt-3">
